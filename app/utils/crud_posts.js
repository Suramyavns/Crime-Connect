...
export async function createPost(data) {
    try {
        return await db.createDocument(dbID, 'posts', ID.unique(), data);
    } catch (error) {
...
export async function getPost(documentId) {
    try {
        return await db.getDocument(dbID, 'posts', documentId);
    } catch (error) {
...
export async function updatePost(documentId, data) {
    try {
        return await db.updateDocument(dbID, 'posts', documentId, data);
    } catch (error) {
...
export async function deleteDocument(documentId) {
    try {
        return await db.deletePost(dbID, 'posts', documentId);
    } catch (error) {
...
export async function listPosts() {
    try {
        return await db.listDocuments(dbID, 'posts');
    } catch (error) {
 ...
 */
export async function listPostsWithFilter(filters) {
    try {
        return await db.listDocuments(dbID, 'posts', filters);
    } catch (error) {
 ...
 */
export async function queryPost(field, value) {
    try {
        return await db.listDocuments(dbID, 'posts', [Query.equal(field, value)]);
    } catch (error) {
 ...
 * ]);
 */
export async function queryPostsWithMultipleConditions(conditions) {
    try {
        const queries = conditions.map(condition => Query.equal(condition.field, condition.value));
        return await db.listDocuments(dbID, 'posts', queries);
    } catch (error) {
